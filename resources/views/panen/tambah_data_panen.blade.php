...
<body>
  ...
  <main id="main" class="main">
    <section class="section dashboard">
        <div class="card">
            <div class="card-body">
            <h5 class="card-title">Tambah Dataset Panen</h5>
            <form action="{{ url('/simpan-data-panen') }}" method="post" class="row g-3">
                {{ csrf_field() }}
                <div class="col-12">
                    <label class="form-label">Nama Petani</label>
                    <select id="selectPetani" name="nik_petani" class="form-control form-control-user" >
                        <option value="" disabled selected>Nama Petani</option>
